...
class RewardModelTrainer(ABC):
    ...
    def __init__(self, model, strategy, optim: Optimizer, train_dataloader, eval_dataloader, scheduler, tokenizer,
                 max_norm=0.5, max_epochs=2, only_evaluate=False, loss="sigmoid", gradient_checkpointing=False,):
        super().__init__()
