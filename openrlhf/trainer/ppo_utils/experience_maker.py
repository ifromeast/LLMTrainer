...
class NaiveExperienceMaker(ABC):
    ...
    def make_experience(self, input_ids: torch.Tensor, **generate_kwargs) -> Experience:
        ...
        advantage, returns = self.get_advantages_and_returns(value, reward, action_mask,
                                                             generate_kwargs["gamma"], generate_kwargs["lambd"],)
    ...
    @torch.no_grad()
    def get_advantages_and_returns(self, values: torch.Tensor, rewards: torch.Tensor, action_mask: torch.Tensor,
                                   gamma: float, lambd: float,) -> Tuple[torch.Tensor, torch.Tensor]:
...
class RemoteExperienceMaker(NaiveExperienceMaker):
    ...
    def make_experience(self, input_ids: torch.Tensor, **generate_kwargs) -> Experience:
        ...
        experience = Experience(sequences, action_log_probs, value, returns, advantage, attention_mask, action_mask, info,)
